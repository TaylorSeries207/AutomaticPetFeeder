...
<html>
    ...
    <head><title>Web Page Controlled Stepper 4OI6</title></head>
    <body>
    <h2> Web Page to Control Stepper 4OI6 Capstone team</h2>
...
def test():
    ...
    #if (int(slider)>10):
    mymotortest.motor_go(True, "Full" , 600,11*.0004, False, .05)
